        ...
        messages=[
            {"role": "system", "content": """You are a Planner Agent in a workflow system. 
             ...
             3. Output your plan as a JSON object with these keys:
                - "search_task": description of the task for the Search Agent, or null if not needed, though its mostly need so do include it.
                - "extraction_task": description of the task for the Retriever Agent, or null if not needed.
                - "summarizer_task": description of the task for the Summarizer Agent, or null if not needed.
             4. Be intelligent in task division:
                - Use the **Extraction Agent** for pulling data from user uploaded sources.
             ...
             
             {
               ...
               "extraction_task": "extract uploaded PDFs on AI applications",
